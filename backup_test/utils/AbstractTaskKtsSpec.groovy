...
package com.intershop.gradle.gitflow.test.utils

import com.intershop.gradle.scm.services.SSHConnector
...
class AbstractTaskKtsSpec extends AbstractScmKtsSpec {
    ...
    protected void prepareGitCheckout(File testProject, String source, String branch) {
        ...
        tempDir.listFiles().each {File src ->
            if(src.isDirectory()) {
                ...
                if(src.name != 'build.gradle.kts' && src.name != 'settings.gradle.kts') {
