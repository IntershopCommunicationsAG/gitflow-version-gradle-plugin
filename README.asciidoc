...
All task are part of the package `'com.intershop.gradle.gitflow.task'`

== Project Extension 'scm'

This plugin adds an extension *`gitflow`* to the root project. This extension contains all plugin configurations.
...
|*versionService* | `VersionService` | | | This service contains methods and properties
